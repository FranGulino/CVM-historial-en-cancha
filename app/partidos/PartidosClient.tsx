...
export default function PartidosClient({ matches, userId }: PartidosClientProps) {
  ...
  const itemsPerPage = 6; // Límite de partidos por página para dar máximo "aire" y espacio en grilla de 2 columnas
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 pb-16 space-y-8 bg-[#111412] font-sans">
      ...
      {/* Cabecera del Dashboard (SCREEN_19 adaptado a Fixture Federal A) */}
      ...
      {/* Pestañas de Fases del Torneo (Federal A) */}
      ...
      {/* Componentes de Filtrado Horizontal (Altura 40px) */}
      ...
      {/* Grid de Partidos de 2 columnas */}
      {currentMatches.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Tarjeta interactiva dashed de registro al final de la grilla */}
